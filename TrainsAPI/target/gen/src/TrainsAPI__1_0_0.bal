...
import wso2/gateway;
    ...
    http:Client TrainsAPI__1_0_0_prod = new (
gateway:retrieveConfig("trainsEP_prod_endpoint_0","http://localhost:3000"),
config = { 
...
secureSocket:{
    ...
    http:Client TrainsAPI__1_0_0_sand = new (
gateway:retrieveConfig("trainsEP_sand_endpoint_0","http://localhost:3000"),
config = { 
    httpVersion: gateway:getHttpVersion(),
secureSocket:{
    trustStore: {
...
service TrainsAPI__1_0_0 on apiListener,
apiSecureListener {


    @http:ResourceConfig {
        methods:["GET"],
        path:"/schedule/from/{departure}",
        authConfig:{
    ...
    resource function get_6ef59740_6550_4d0a_8661_01ccd39b4205 (http:Caller outboundEp, http:Request req) {
        handleExpectHeaderForTrainsAPI__1_0_0(outboundEp, req);
    
    
    string urlPostfix = untaint req.rawPath.replaceFirst("/trains/1.0.0", "");
    ...
    clientResponse = TrainsAPI__1_0_0_prod->forward(urlPostfix, req);

runtime:getInvocationContext().attributes["destination"] = "http://localhost:3000";
                
                } else {
                
                    
    clientResponse = TrainsAPI__1_0_0_sand->forward(urlPostfix, req);
...
runtime:getInvocationContext().attributes["destination"] = "http://localhost:3000";
    ...
    @gateway:RateLimit{policy : ""}
    resource function get_be815e08_2dc0_4f7d_85d7_975ba8cb0f72 (http:Caller outboundEp, http:Request req) {
        handleExpectHeaderForTrainsAPI__1_0_0(outboundEp, req);
...
runtime:getInvocationContext().attributes["destination"] = "http://localhost:3000";
    ...
    @gateway:RateLimit{policy : ""}
    resource function get_e9ebb5c0_a2a9_4d45_9ad4_92173b311f88 (http:Caller outboundEp, http:Request req) {
        handleExpectHeaderForTrainsAPI__1_0_0(outboundEp, req);
...
runtime:getInvocationContext().attributes["destination"] = "http://localhost:3000";
    ...
    function handleExpectHeaderForTrainsAPI__1_0_0 (http:Caller outboundEp, http:Request req ) {
...
function getUrlOfEtcdKeyForReInitTrainsAPI__1_0_0(string defaultUrlRef,string etcdRef, string defaultUrl, string etcdKey) returns string {
